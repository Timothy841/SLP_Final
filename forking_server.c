...
void subserver(int opponent_socket) {
  ...
  printf("Type in {0, 1, 2, 3, 4, 5, 6} to put your piece on the board. Type in {ls} to see all save files. Type {save} to save. Type {load} to load save file.\n");
